...
import "../FaseCuatro/EscolarCuatro.css";
...
export const FaseCuatroEscolar = ({informacion,actualizar,setActualizar}) => {
  ...
  useEffect(() => {
    if (informacion) {
      setFormData({
        reporte: informacion.faseCuatro?.reporte_tres || "",
        estado: informacion.faseCuatro?.estatus_envio || "",
        comentario: informacion.faseCuatro?. comentario || "",
      });
      ...
      if(informacion.faseCuatro ===null){
        ...
        setVisible2(informacion.faseCuatro?.estatus_envio);
      }
...
const cambiarEstadoInforme3 = (estado) => {
  axios
    .patch(
      `${apiUrl}cambio/estado/informe3/${informacion.estudiante.matricula}/${estado}`,
      {},
      {
        headers: {
...
{mostrarComponente2 && <VentanaInforme3
