...
import "../FaseCuatro/EstudianteCuatro.css";
...
export const FaseCuatroEstudiante = ({informacion, actualizar,setActualizar}) => {
  ...
  if(informacion){
    setFormData({
      ...
      reporte_dos:informacion.faseCuatro?.reporte_tres || "",
...
const cambiarInforme3 = (dato) => {
  axios
    .patch(
      `${apiUrl}estado/cambio/presentacion/informe3/${dato}`,
      {},
      {
        headers: {
...

{
  table: {
    ...
    [
      { text: 'Mes 5', style: 'tabla' },
      { text: `${formData.actividad}`, style: 'tabla' }
  ], // Primera fila
  [
    { text: 'Mes 6', style: 'tabla' },
    { text: `${formData.actividad}`, style: 'tabla' }
], // Primera fila
    ],
    heights: [40, 50, 50],
...
{ text:  `\nObservaciones:________________________________________________________________________________________________________________________________________________________________`, style: 'obser' },
  ...
  const handleSubmitInforme3 = async () => {
    ...
    if (selectedFile) {
        ...
        axios
        .post(`${apiUrl}subir/doc/informe3`, formData, {
          headers: {
            Authorization: `Bearer ${token}`,
...
<button className="subir-3z" onClick={handleSubmitInforme3}>Subir</button>
