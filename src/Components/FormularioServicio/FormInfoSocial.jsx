...
export const FormInfoSocial = ({
  ...
  const cambiarEstado = (estado) => {
    axios
      .patch(
        `${apiUrl}cambiar/estado/social/${estado}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <div className="Festudiante">
      <form onSubmit={handleSubmit}>
        ...
        {estatus_envio === 0 && (
          <div>
             <span className="estado">ESTADO: INFORMACION SIN ENVIAR</span>
  ...
  <VentanaConfirmacion
        ...
        {estatus_envio === 1 && (
          <div>
            <span className="estado">ESTADO: INFORMACION ENVIADA PARA REVISION</span>
          </div>
        )}

        {estatus_envio === 2 && (
          <div>
            <span className="estado">ESTADO: REVISADO</span>
          </div>
        )}
      </form>
